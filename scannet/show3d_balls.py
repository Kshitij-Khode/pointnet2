...
def showpoints(xyz,c_gt=None, c_pred = None ,waittime=1,showrot=True,magnifyBlue=0,freezerot=False,background=(0,0,0),normalizecolor=False,ballradius=10, filename='test0_0.png'):
...
if __name__=='__main__':
    np.random.seed(100)
    print(np.random.randn(2500,3))
    print(np.ones((2500,3))/2)
    showpoints(np.random.randn(2500,3), c_pred=np.zeros((2500,3)))
